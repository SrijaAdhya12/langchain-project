...
<div align=center>
    <a href="https://github.com/SrijaAdhya12/langchain-project">
        <img width="200" src="https://img.icons8.com/?size=1000&id=46874" alt="langchain-project">
    </a>
    <p style="font-family: roboto,calibri,serif; font-size:12pt; font-style:italic"> A good one liner description here </p>
    <a href="https://github.com/SrijaAdhya12/langchain-project/forks">
        <img alt="GitHub forks" src="https://img.shields.io/github/forks/SrijaAdhya12/langchain-project">
    </a>
</div>

# [Langchain Project](https://github.com/SrijaAdhya12/langchain-project)
...
2. Go to [**Security**](https://github.com/SrijaAdhya12/langchain-project/security) tab.
3. Click on **Security Overview**.
4. Click on `Enable Dependabot alerts` button.

- Enable Code Scanning Alerts

1. Go to [Code security and analysis](https://github.com/SrijaAdhya12/langchain-project/settings/security_analysis#code_scanning_settings) section in settings.
...
<div align="center">
    <a href="https://github.com/SrijaAdhya12/langchain-project/graphs/contributors">
        <img src="https://contrib.rocks/image?repo=SrijaAdhya12/langchain-project" alt="contributors"/>
    </a>
</div>
...
[License]: https://github.com/SrijaAdhya12/langchain-project/blob/main/LICENSE
